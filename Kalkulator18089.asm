...
proc WinMain, hInstance, hPrevInstance, lpCmdLine, nCmdShow
	...
	call CreateWindowExA, WS_EX_CLIENTEDGE, ClassName, "KALKULATOR SEDERHANA", WS_OVERLAPPEDWINDOW, 364, 128, 300, 225, NULL, NULL, [hInstance], NULL
	mov dword[hwnd], eax
...
proc WinProc, hWnd, uMsg, wParam, lParam
    ...
    ;------
    .CREATE:
	call CreateWindowExA, WS_EX_CLIENTEDGE, EditClassName, "", WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_AUTOHSCROLL, 50,35,175,25,[hWnd],EditID1,[Instance],NULL
	mov [hwndEdit1],eax
	call SetFocus, [hwndEdit1]
	call CreateWindowExA, WS_EX_CLIENTEDGE, EditClassName, "", WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_AUTOHSCROLL, 50,75,175,25,[hWnd],EditID2,[Instance],NULL
	mov [hwndEdit2],eax
	...
	mov  [hwndButton],eax
	call CreateWindowExA, NULL, ButtonClassName, ButtonText2, WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON, 100,130,25,25,[hWnd],ButtonID2,[Instance],NULL
	mov  [hwndButton],eax
	call CreateWindowExA, NULL, ButtonClassName, ButtonText3, WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON, 150,130,25,25,[hWnd],ButtonID3,[Instance],NULL
	mov  [hwndButton],eax
	call CreateWindowExA, NULL, ButtonClassName, ButtonText4, WS_CHILD | WS_VISIBLE | BS_DEFPUSHBUTTON, 200,130,25,25,[hWnd],ButtonID4,[Instance],NULL
	mov  [hwndButton],eax
    return FALSE
	...
	mov [buffer1],eax                               ;menyimpan integer hasil konversi ke buffer1
	str2int buffer2
	mov [buffer2],eax
	mov eax,[buffer1]
	mov ebx,[buffer2]
